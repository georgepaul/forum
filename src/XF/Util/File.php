...
class File
{
	...
	public static function getNamedTempFile($fileName)
	{
	...
	public static function copyStreamToTempFile($sourceResource)
	{
	...
	public static function copyAbstractedPathToTempFile($abstractedPath)
	{
		$stream = \XF::app()->fs()->readStream($abstractedPath);
		$tempFile = self::copyStreamToTempFile($stream);
