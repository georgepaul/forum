...
class Gravatar extends AbstractRebuildJob
{
	...
	protected function setupData(array $data)
	{
		...
		{
			throw new \InvalidArgumentException("Gravatar support is switched off. Turn it on in 'Options:  User options' to continue.");
		}
		...
		else if (!empty($data['import_table_name']))
		{
			...
			{
				throw new \InvalidArgumentException("The database does not contain a table called '{$data['import_table_name']}'.");
			}
		}
