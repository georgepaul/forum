...
ENTITYOUT;
		...
		if ($input->getOption('write'))
		{
			...
			if ($parts[0] === 'XF')
			{
				$path = \XF::getSourceDirectory() . DIRECTORY_SEPARATOR . implode(DIRECTORY_SEPARATOR, $parts);
			}
			else
			{
				$path = \XF::getAddOnDirectory() . DIRECTORY_SEPARATOR . implode(DIRECTORY_SEPARATOR, $parts);
			}
