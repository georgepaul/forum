...
{galleryId:a.data("lb-id")});a.lightGallery(c);a.data("lbInitialized",!0);c=b.Event("lightbox:init");a.trigger(c);a.on("onAfterSlide.lg",b.proxy(this,"afterSlide"))}},_reInitContainer:function(a){if(a.data("lbInitialized")){var b=a.data("lightGallery");b&&b.destroy(!0);a.find(this.options.lbTrigger).off("click.xflbtrigger");a.removeData("lbInitialized");this._initContainer(a)}},checkReInit:function(a,c){if(c!=d&&this.$target.find(c).length){a=b(c);c=this.options.lbTrigger;var g=this.options.lbContainer;
...
b(a).data("lightGallery");this.$el=b(a);this.core.s=b.extend({},d,this.core.s);this.init();return this};e.prototype.init=function(){this.core.s.captionLoader&&(this.$el.one("onAfterOpen.lg",b.proxy(this,"captionAfterOpen")),this.$el.on("onAfterAppendSubHtml.lg",b.proxy(this,"captionLoaded")))};e.prototype.captionAfterOpen=function(){var a=this.$el;a.data("captionsProcessed")||(a.find(".js-lbImage").each(function(){var a=b(this),c=a.find("img"),d=a.closest(".js-lbContainer"),e=d.data("lb-id");c={title:d.data("lb-caption-title")||
c.attr("alt")||c.attr("title")||"",desc:d.data("lb-caption-desc")||"",href:e?f.location.href.replace(/#.*$/,"")+"#"+e:null};a.attr("data-sub-html",Mustache.render('<h4>{{title}}</h4><p><a href="{{href}}">{{desc}}</a></p>',c))}),a.data("captionsProcessed",!0))};e.prototype.captionLoaded=function(){this.core.$outer.find(this.core.s.appendSubHtmlTo+" a").on("click",b.proxy(this,"captionLinkClicked"))};e.prototype.captionLinkClicked=function(a){setTimeout(function(){f.location.href=b(a.target).attr("href")},
50)};e.prototype.destroy=function(){this.$el.off("onAfterOpen.lg onAfterAppendSubHtml.lg")};b.fn.lightGallery.modules.newwindow=c;b.fn.lightGallery.modules.captionloader=e}});XF.Element.register("lightbox","XF.Lightbox")}(jQuery,window,document);
