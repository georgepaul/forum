 ...
 */
var $jscomp=$jscomp||{};$jscomp.scope={};$jscomp.findInternal=function(b,g,d){b instanceof String&&(b=String(b));for(var f=b.length,a=0;a<f;a++){var c=b[a];if(g.call(d,c,a,b))return{i:a,v:c}}return{i:-1,v:void 0}};$jscomp.ASSUME_ES5=!1;$jscomp.ASSUME_NO_NATIVE_MAP=!1;$jscomp.ASSUME_NO_NATIVE_SET=!1;$jscomp.defineProperty=$jscomp.ASSUME_ES5||"function"==typeof Object.defineProperties?Object.defineProperty:function(b,g,d){b!=Array.prototype&&b!=Object.prototype&&(b[g]=d.value)};
$jscomp.getGlobal=function(b){return"undefined"!=typeof window&&window===b?b:"undefined"!=typeof global&&null!=global?global:b};$jscomp.global=$jscomp.getGlobal(this);$jscomp.polyfill=function(b,g,d,f){if(g){d=$jscomp.global;b=b.split(".");for(f=0;f<b.length-1;f++){var a=b[f];a in d||(d[a]={});d=d[a]}b=b[b.length-1];f=d[b];g=g(f);g!=f&&null!=g&&$jscomp.defineProperty(d,b,{configurable:!0,writable:!0,value:g})}};
$jscomp.polyfill("Array.prototype.find",function(b){return b?b:function(b,d){return $jscomp.findInternal(this,b,d).v}},"es6","es3");
!function(b,g,d,f){XF.Filter=XF.Element.newHandler({options:{inputEl:"| .js-filterInput",prefixEl:"| .js-filterPrefix",clearEl:"| .js-filterClear",countEl:".js-filterCount",totalsEl:".js-displayTotals",searchTarget:null,searchRow:null,searchRowGroup:null,searchLimit:"",key:"",ajax:null,noResultsFormat:'<div class="js-filterNoResults">%s</div>'},storageContainer:"filter",storageCutOff:3600,storageKey:null,$input:null,$prefix:null,$clear:null,$count:null,$displayTotals:null,$search:null,$noResults:null,
...
a);this.$count=XF.findRelativeIf(this.options.countEl,a.closest("form, .block"));this.$displayTotals=XF.findRelativeIf(this.options.totalsEl,a.closest("form",".block"));this.$input.on({keyup:b.proxy(this,"onKeyUp"),keypress:b.proxy(this,"onKeyPress"),paste:b.proxy(this,"onPaste")});this.$prefix.on("change",b.proxy(this,"onPrefixChange"));this.$clear.on("click",b.proxy(this,"onClearFilter"));this.storageKey=this.options.key;this.storageKey.length||(a=a.closest("form"),a.length&&(this.storageKey=a.attr("action")));
if(a=this._getStoredValue())this.$input.val(a.filter),this.$prefix.prop("checked",a.prefix);this.$input.val().length&&this.update();this._cleanUpStorage()},onKeyUp:function(a){if(!a.ctrlKey&&!a.metaKey){switch(a.which){case 9:case 13:case 16:case 17:case 18:break;default:this.planUpdate()}13!=a.which&&this.planUpdate()}},onKeyPress:function(a){13==a.which&&(a.preventDefault(),this.update())},onPaste:function(a){this.planUpdate()},onPrefixChange:function(a){this.update()},onClearFilter:function(a){this.$clear.is(".is-disabled")||
(this.$input.val(""),this.$prefix.prop("checked",!1),this.update())},planUpdate:function(){this.updateTimer&&clearTimeout(this.updateTimer);this.updateTimer=setTimeout(b.proxy(this,"update"),250)},update:function(){this.updateTimer&&clearTimeout(this.updateTimer);this.filter(this.$input.val(),this.$prefix.is(":checked")?!0:!1)},_getSearchRows:function(a){a||(a=this.$search);a=a.find(this.options.searchRow);this.$noResults&&(a=a.not(this.$noResults));return a},filter:function(a,b){this._updateStoredValue(a,
b);this._toggleFilterHide(0<a.length);this.options.ajax?this._filterAjax(a,b):(a=this._applyFilter(this._getSearchRows(),a,b),this._toggleNoResults(0==a))},_filterAjax:function(a,c){this.xhr&&(this.xhr.abort(),this.xhr=null);if(a.length){var e={_xfFilter:{text:a,prefix:c?1:0}};this.xhrFilter={text:a,prefix:c};this.xhr=XF.ajax("GET",this.options.ajax,e,b.proxy(this,"_filterAjaxResponse"))}else this._clearAjaxRows(),a=this._applyFilter(this._getSearchRows(),a,c),this._toggleNoResults(0==a)},_filterAjaxResponse:function(a){this.xhr=
null;this._clearAjaxRows();a=b(b.parseHTML(a.html.content)).find(this.options.searchRow);var c=this.xhrFilter;this._getSearchRows().addClass("is-hidden");this._applyRowGroupLimit();this._toggleNoResults(0==a.length);a.length?(this._appendRows(a),XF.activate(a),this.$ajaxRows=a,this._applyFilter(a,c.text,c.prefix)):XF.layoutChange();this.xhrFilter=null},_applyFilter:function(a,c,e){var h=this.options.searchLimit,d=0,g=this;if(c.length){var f=new RegExp((e?"^":"")+"("+XF.regexQuote(c)+")","i");var k=
new RegExp((e?"^":"")+"("+XF.regexQuote(XF.htmlspecialchars(c))+")","ig")}else k=f=!1;a.each(function(){var a=b(this),c=!1,e=h?a.find(h):a;e.find(".is-match").each(function(){var a=this.parentNode;b(this).replaceWith(this.childNodes);a.normalize()});!f||a.hasClass("js-filterForceShow")?c=!0:e.each(function(){g._searchFilter(this,f,k)&&(c=!0)});c?(a.removeClass("is-hidden"),d++):a.addClass("is-hidden")});this._applyRowGroupLimit(0==c.length);this.updateDisplayTotals(d);XF.layoutChange();return d},
_applyRowGroupLimit:function(a){var c=this.options.searchRowGroup,e=this.options.searchRow;c&&this.$search.find(c).each(function(){var c=b(this),d=c.find(e).filter(":not(.is-hidden)");a||d.length?c.removeClass("is-hidden"):c.addClass("is-hidden")})},_searchFilter:function(a,c,e){var d=!1;if(3==a.nodeType)c.test(a.data)&&(d=!0,c=XF.htmlspecialchars(a.data).replace(e,'<span class="is-match">$1</span>'),b(a).replaceWith(b.parseHTML(c)));else{a=a.childNodes;for(var f=a.length-1;0<=f;f--)this._searchFilter(a[f],
c,e)&&(d=!0)}return d},_clearAjaxRows:function(){this.$ajaxRows&&(this.$ajaxRows.remove(),this.$ajaxRows=null)},_toggleFilterHide:function(a){this.$clear.toggleClass("is-disabled",!a);b(".js-filterHide").css("display",a?"none":"")},_toggleNoResults:function(a){a?(this.getNoResultsRow().removeClass("is-hidden"),this.updateDisplayTotals(0)):this.$noResults&&this.$noResults.addClass("is-hidden")},updateDisplayTotals:function(a){this.$count.text(a);if(this.$displayTotals.length){this.$displayTotals.data("count",
