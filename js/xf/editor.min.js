...
b);c.events.on("image.loaded",function(b){if(c.popups.isVisible("image.edit")){var d=c.image.get();d&&d[0]==b[0]&&(c.image.exitEdit(!0),d=c.selection.ranges(0),d.setStartAfter(b[0]),d.collapse(!0),b=c.selection.get(),b.removeAllRanges(),b.addRange(d),c.events.focus(),a.scrollToCursor())}})},handleUploadSuccess:function(a,c,b){try{var e=d.parseJSON(a)}catch(f){e={status:"error",errors:[XF.phrase("oops_we_ran_into_some_problems")]}}return e.status&&"error"==e.status?(XF.alert(e.errors[0]),c?c(e):!1):
...
var c=a.$box,b=a.$wp,d=a.selection.endElement(),f=d.getBoundingClientRect().bottom,h=!0;a=XF.windowHeight();XF.browser.ios&&(a-=250);if(0>f||f>=a)h=!1;if(b&&h){var g=b[0].getBoundingClientRect();if(f>g.bottom||f<g.top)h=!1}if(!h){f=c[0].getBoundingClientRect();if(0>f.top||f.bottom>=a)XF.browser.ios||c.addClass("is-scrolling-to"),c[0].scrollIntoView(!0),c.removeClass("is-scrolling-to");b?(f=d.getBoundingClientRect().bottom,c=b[0].scrollTop+f-b[0].getBoundingClientRect().top,b.scrollTop(c+a/2)):d.scrollIntoView()}}},
...
this;this.ed=a;this.results=new XF.AutoCompleteResults({onInsert:function(a){c.insertMention(a)},clickAttacher:function(a,d){c.ed.events.bindClick(a,a,d)}});a.events.on("keydown",d.proxy(this,"keydown"),!0);a.events.on("keyup",d.proxy(this,"keyup"),!0);a.events.on("click blur",function(){c.hide()});a.$wp.onPassive("scroll",function(){c.hide()})},keydown:function(a){if(this.visible){var c=this.results,b=function(){a.preventDefault();return!1};switch(a.which){case 40:return c.selectResult(1),b();case 38:return c.selectResult(-1),
b();case 27:return this.hide(),b();case 13:return c.insertSelectedResult(),b()}}},keyup:function(a){if(this.visible)switch(a.which){case 40:case 38:case 13:return}this.hide();this.idleTimer&&clearTimeout(this.idleTimer);this.idleTimer=setTimeout(d.proxy(this,"lookForMention"),this.idleWait)},lookForMention:function(){var a=this.getCurrentMentionInfo();a?this.foundMention(a.name):this.hide()},getCurrentMentionInfo:function(){var a=this.ed.selection.ranges(0);if(!a||!a.collapsed)return null;var c=a.endContainer;
if(!c||3!=c.nodeType)return null;var b=c.nodeValue.substring(0,a.endOffset),d=b.lastIndexOf("@");if(-1==d)return null;if(0==d||b.substr(d-1,1).match(/(\s|[\](,]|--)/))if(b=b.substr(d+1),!b.match(/\s/)||10>=b.length)return{textNode:c,start:d,name:b.replace(new RegExp(String.fromCharCode(160),"g")," "),range:a};return null},foundMention:function(a){this.pendingMention!=a&&(this.pendingMention=a,2<=a.length&&"["!=a.substr(0,1)&&this.getPendingMentionOptions())},getPendingMentionOptions:function(){XF.ajax("GET",
XF.getAutoCompleteUrl(),{q:this.pendingMention},d.proxy(this,"handlePendingMentionOptions"),{global:!1,error:!1})},handlePendingMentionOptions:function(a){var c=this.getCurrentMentionInfo();a.q&&c&&a.q==c.name&&(a.results?this.show(a.q,a.results):this.hide())},insertMention:function(a){this.hide();XF.EditorHelpers.focus(this.ed);var c=this.getCurrentMentionInfo();if(c){var b=c.textNode,d=b.nodeValue,f=c.start+1,h=c.range;b.nodeValue=d.substr(0,f)+a+"\u00a0"+d.substr(f+c.name.length);h.setEnd(b,f+
a.length+1);h.collapse(!1);a=this.ed.selection.get();a.removeAllRanges();a.addRange(h)}},show:function(a,c){var b=this.getCurrentMentionInfo(),e=b.range,f=this.ed.$el;b&&(this.visible=!0,this.results.showResults(a,c,f,function(a){var c=f.dimensions();if(!e||!e.getBoundingClientRect){var k=e.startContainer;return{top:(3==k.nodeType?d(k.parentNode):d(k)).dimensions().bottom+3,left:c.left+5}}k=e.cloneRange();k.setStart(b.textNode,b.start);k.setEnd(b.textNode,b.start+1);k=k.getBoundingClientRect();a=
a.width();var h=k.bottom+d(l).scrollTop()+3;k=k.left;k+a>c.right&&(k=e.getBoundingClientRect().left-a);k<c.left&&(k=c.left);return{top:h,left:k}}))},hide:function(){this.visible&&(this.visible=!1,this.results.hideResults())}});XF.EditorHelpers={setupBlurSelectionWatcher:function(a){var c=a.$el,b=!1,e;d(m).on("mousedown keydown",function(c){b&&(a.$el[0]==c.target||d.contains(a.$el[0],c.target)||a.selection.inEditor()&&(e=a.selection.ranges(0)))});a.events.on("blur",function(){e?c.data("xf-ed-blur-sel",
e):c.removeData("xf-ed-blur-sel");b=!1;e=null},!0);a.events.on("focus",function(){b=!0;e=null;setTimeout(function(){c.removeData("xf-ed-blur-sel")},0)});a.events.on("commands.before",function(b){(b=d.FE.COMMANDS[b])&&("undefined"==typeof b.focus||b.focus)&&XF.EditorHelpers.restoreMaintainedSelection(a)})},restoreMaintainedSelection:function(a){var c=a.$el.data("xf-ed-blur-sel");a.selection.inEditor()||(c?(a.markers.remove(),a.markers.place(c,!0,0),a.markers.place(c,!1,0)):a.selection.setAtEnd(a.el),
a.selection.restore())},focus:function(a){XF.EditorHelpers.restoreMaintainedSelection(a);a.events.focus()},wrapSelectionText:function(a,c,b,d){d&&a.selection.save();d=a.$el.find(".fr-marker");d.first().before(XF.htmlspecialchars(c));d.last().after(XF.htmlspecialchars(b));a.selection.restore();a.placeholder.hide()},insertCode:function(a,c,b){switch(c.toLowerCase()){case "":var d="CODE";c="";break;default:d="CODE",c=c.toLowerCase()}b=b.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,
"&quot;").replace(/\t/g,"    ").replace(/\n /g,"\n&nbsp;").replace(/  /g,"&nbsp; ").replace(/  /g," &nbsp;").replace(/\n/g,"</p><p>");b="["+d+(c?"="+c:"")+"]"+b+"[/"+d+"]";b.match(/<\/p>/i)&&(b=("<p>"+b+"</p>").replace(/<p><\/p>/g,"<p><br></p>"));a.html.insert(b)},insertSpoiler:function(a,c){XF.EditorHelpers.wrapSelectionText(a,c?'[SPOILER="'+c+'"]':"[SPOILER]","[/SPOILER]",!0)},dialogs:{},loadDialog:function(a,c){var b=XF.EditorHelpers.dialogs;b[c]?b[c].show(a):console.error("Unknown dialog '"+c+
"'")},toggleSmilieBox:function(a,c){var b=a.$oel.data("xfSmilieBox");b&&(a.$wp.toggleClassTransitioned("smilieBox-active",c),b.toggleClassTransitioned("is-active",c),a.$tb.find(".fr-command[data-cmd=xfSmilie]").toggleClass("fr-active xxx",c))}};XF.EditorDialog=XF.create({ed:null,overlay:null,dialog:null,cache:!0,__construct:function(a){this.dialog=a},show:function(a){this.ed=a;a.selection.save();XF.loadOverlay(XF.canonicalizeUrl("index.php?editor/dialog&dialog="+this.dialog),{beforeShow:d.proxy(this,
"beforeShow"),afterShow:d.proxy(this,"afterShow"),init:d.proxy(this,"init"),cache:this.cache})},init:function(a){var c=this;a.on("overlay:hidden",function(){c.ed&&c.ed.markers.remove()});this._init(a)},_init:function(a){},beforeShow:function(a){this.overlay=a;this._beforeShow(a)},_beforeShow:function(a){},afterShow:function(a){this._afterShow(a);a.$overlay.find("textarea, input").first().focus()},_afterShow:function(a){}});XF.EditorDialogMedia=XF.extend(XF.EditorDialog,{_beforeShow:function(a){d("#editor_media_url").val("")},
_init:function(a){d("#editor_media_form").submit(d.proxy(this,"submit"))},submit:function(a){a.preventDefault();var c=this.ed,b=this.overlay;XF.ajax("POST",XF.canonicalizeUrl("index.php?editor/media"),{url:d("#editor_media_url").val()},function(a){a.matchBbCode?(c.selection.restore(),c.html.insert(XF.htmlspecialchars(a.matchBbCode)),b.hide()):a.noMatch?XF.alert(a.noMatch):(c.selection.restore(),b.hide())})}});XF.EditorDialogSpoiler=XF.extend(XF.EditorDialog,{_beforeShow:function(a){d("#editor_spoiler_title").val("")},
_init:function(a){d("#editor_spoiler_form").submit(d.proxy(this,"submit"))},submit:function(a){a.preventDefault();a=this.ed;var c=this.overlay;a.selection.restore();XF.EditorHelpers.insertSpoiler(a,d("#editor_spoiler_title").val());c.hide()}});XF.EditorDialogCode=XF.extend(XF.EditorDialog,{_beforeShow:function(a){this.ed.$el.blur()},_init:function(a){d("#editor_code_form").submit(d.proxy(this,"submit"))},submit:function(a){a.preventDefault();a=this.ed;var c=this.overlay,b=c.$container.find(".CodeMirror");
if(b.length){b=b[0].CodeMirror;var e=b.getDoc();b.save();e.setValue("");b.setOption("mode","")}b=d("#editor_code_type");e=d("#editor_code_code");a.selection.restore();XF.EditorHelpers.insertCode(a,b.val(),e.val());c.hide();e.val("");b.val("")}});XF.editorStart={started:!1,custom:[],startAll:function(){XF.editorStart.started||(XF.editorStart.setupLanguage(),XF.editorStart.registerCommands(),XF.editorStart.registerCustomCommands(),XF.editorStart.registerDialogs(),d(m).trigger("editor:first-start"),
XF.editorStart.started=!0)},setupLanguage:function(){var a=d("html").attr("dir");try{var c=d.parseJSON(d(".js-editorLanguage").first().html())||{}}catch(b){console.error(b),c={}}d.FE.LANGUAGE.xf={translation:c,direction:a?a.toLowerCase():"ltr"}},registerCommands:function(){d.FE.DefineIcon("xfQuote",{NAME:"quote-right"});d.FE.RegisterCommand("xfQuote",{title:"Quote",icon:"xfQuote",undo:!0,focus:!0,callback:function(){XF.EditorHelpers.wrapSelectionText(this,"[QUOTE]","[/QUOTE]",!0)}});d.FE.DefineIcon("xfCode",
{NAME:"code"});d.FE.RegisterCommand("xfCode",{title:"Code",icon:"xfCode",undo:!0,focus:!0,callback:function(){XF.EditorHelpers.loadDialog(this,"code")}});d.FE.DefineIcon("xfInlineCode",{NAME:"terminal"});d.FE.RegisterCommand("xfInlineCode",{title:"Inline Code",icon:"xfInlineCode",undo:!0,focus:!0,callback:function(){XF.EditorHelpers.wrapSelectionText(this,"[ICODE]","[/ICODE]",!0)}});d.FE.DefineIcon("xfMedia",{NAME:"video-camera"});d.FE.RegisterCommand("xfMedia",{title:"Media",icon:"xfMedia",undo:!0,
focus:!0,callback:function(){XF.EditorHelpers.loadDialog(this,"media")}});d.FE.DefineIcon("xfSpoiler",{NAME:"flag"});d.FE.RegisterCommand("xfSpoiler",{title:"Spoiler",icon:"xfSpoiler",undo:!0,focus:!0,callback:function(){XF.EditorHelpers.loadDialog(this,"spoiler")}});d.FE.DefineIcon("xfSmilie",{NAME:"smile-o"});d.FE.RegisterCommand("xfSmilie",{title:"Smilies",icon:"xfSmilie",undo:!1,focus:!1,refresh:function(a){var c=this.$oel.data("xfSmilieBox"),b=!1;c&&(b=c.hasClass("is-active"));a.toggleClass("fr-active",
b)},callback:function(){var a=this,c=a.$oel.data("xfSmilieBox");if(c){var b=c.hasClass("is-active");XF.EditorHelpers.toggleSmilieBox(a,b?!1:!0)}else c=d('<div class="editorSmilies" />'),a.$oel.data("xfSmilieBox",c),a.$wp.before(c),XF.ajax("GET",XF.canonicalizeUrl("index.php?editor/smilies"),{},function(b){b.html&&XF.setupHtmlInsert(b.html,function(b){a.events.bindClick(c,"img.smilie",function(b){b=d(b.currentTarget).clone();b.addClass("fr-draggable");XF.EditorHelpers.focus(a);a.html.insert(d("<div />").html(b).html())});
c.html(b);XF.EditorHelpers.toggleSmilieBox(a,!0)})})}});d.FE.DefineIcon("xfDraft",{NAME:"floppy-o"});d.FE.RegisterCommand("xfDraft",{type:"dropdown",title:"Drafts",focus:!0,undo:!1,options:{xfDraftSave:"Save Draft",xfDraftDelete:"Delete Draft"},callback:function(a,c){a=this.$el.closest("form");a.length?(a=XF.Element.getHandler(a,"draft"))?"xfDraftSave"==c?a.triggerSave():"xfDraftDelete"==c&&a.triggerDelete():console.error("No draft handler on parent form"):console.error("No parent form to find draft handler")}});
d.extend(d.FE.DEFAULTS,{xfBbCodeAttachmentContextInput:"attachment_hash_combined"});d.FE.PLUGINS.bbCode=function(a){function c(){return a.$tb.find(".fr-command[data-cmd=xfBbCode]")}function b(){var b=a.$oel,c=b.data("xfBbCodeBox");if(!c){var e=parseInt(a.$wp.css("border-bottom-width"),10)+parseInt(a.$wp.css("border-top-width"),10);c=d('<textarea class="input" style="display: none" />');c.css({minHeight:a.opts.heightMin?a.opts.heightMin+e+"px":null,maxHeight:a.opts.heightMax?a.opts.heightMax+"px":
