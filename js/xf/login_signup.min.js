...
!function(a,d,b,e){XF.AutoTimeZone=XF.Element.newHandler({init:function(){var a=new Date,b=new Date(a.getFullYear(),0,1);a=new Date(a.getFullYear(),5,1);b=Math.round(b.getTimezoneOffset());a=Math.round(a.getTimezoneOffset());return this.map[b+","+a]?(this.$target.val(this.map[b+","+a]),!0):!1},map:{"660,660":"Pacific/Midway","600,600":"Pacific/Honolulu","570,570":"Pacific/Marquesas","540,480":"America/Anchorage","480,420":"America/Los_Angeles","420,360":"America/Denver","420,420":"America/Phoenix",
...
$timerEl:null,$timerNum:null,timeLeft:0,timerInterval:null,init:function(){var c=this.$target.closest("form");this.$submit=c.find("#js-signUpButton");if(this.$submit.length){this.$disabler=c.find("#js-signUpDisabler");if(this.$disabler.length){var b=a.proxy(this,"updateSubmitState");this.$disabler.click(function(){setTimeout(b,0)})}else this.$disabler=null;this.$timerEl=c.find("#js-regTimer");this.$timerNum=this.$timerEl.find("span");this.$timerNum.length&&(this.timeLeft=parseInt(this.$timerNum.text(),
