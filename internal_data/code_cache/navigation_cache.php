...
return function($__templater, $__selectedNav, array $__vars)
{
	...
	if ($__navTemp) {
		...
		'href' => $__templater->fn('link', array('whats-new/news-feed', ), false),
		'attributes' => [],
	];
			if ($__navTemp) {
		...
		'href' => $__templater->fn('link', array('whats-new/latest-activity', ), false),
		'attributes' => [],
	];
		if ($__navTemp) {
	...
	$__navTemp = [
		...
		'href' => $__templater->fn('link', array('whats-new', ), false),
		'attributes' => [],
	];
	if ($__navTemp) {
	...
	if ($__templater->method($__vars['xf']['visitor'], 'canViewMemberList', array())) {
		...
		'href' => $__templater->fn('link', array('search', null, array('type' => 'profile_post', ), ), false),
		'attributes' => [],
	];
				if ($__navTemp) {
