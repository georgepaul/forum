			...
			'html' => '
				<div class="menu" data-menu="menu" aria-hidden="true" data-menu-builder="dataList">
					<div class="menu-content">
						...
						<a href="' . $__templater->fn('link', array('styles/export', $__vars['style'], ), true) . '" class="menu-linkRow" data-xf-click="overlay">' . 'Export' . '</a>
						<a href="' . $__templater->fn('link', array('styles/customized-components', $__vars['style'], ), true) . '" class="menu-linkRow">' . 'Customized components' . '</a>
