	...
	<div class="block-container">
		<div class="block-body block-row">
			...
			<ul class="listInline listInline--bullet u-muted">
				<li>' . 'Generated by' . $__vars['xf']['language']['label_separator'] . ' ' . ($__vars['entry']['User'] ? (((('<a href="' . $__templater->fn('link', array('users/edit', $__vars['entry'], ), true)) . '">') . $__templater->escape($__vars['entry']['User']['username'])) . '</a>') : 'Unknown account') . '</li>
