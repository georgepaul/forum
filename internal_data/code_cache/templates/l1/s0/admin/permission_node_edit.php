...
';
	$__templater->breadcrumb($__templater->preEscaped($__templater->escape($__vars['record']['title'])), $__templater->fn('link', array('permissions/nodes', $__vars['record'], ), false), array(
	));
	$__finalCompiled .= '
