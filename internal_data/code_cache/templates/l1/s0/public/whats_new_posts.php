...
'results' => function($__templater, array $__arguments, array $__vars)
{
	...
	';
		...
		if ($__vars['xf']['visitor']['user_id'] AND ($__vars['findNew']['filters']['unread'] AND ($__templater->fn('count', array($__vars['findNew']['filters'], ), false) == 1))) {
			$__finalCompiled .= '
				' . 'You have no unread posts. You may <a href="' . $__templater->fn('link', array($__vars['latestRoute'], null, array('skip' => 1, ), ), true) . '" rel="nofollow">view all latest posts</a> instead.' . '
			';
		} else {
			$__finalCompiled .= '
				' . 'No results found.' . '
