...
' . '<p>' . $__templater->escape($__vars['user']['username']) . ', in order to complete your registration or reactivate your account at ' . (((('<a href="' . $__templater->fn('link', array('canonical:index', ), true)) . '">') . $__templater->escape($__vars['xf']['options']['boardTitle'])) . '</a>') . ', you need to confirm your email address by clicking the button below.</p>' . '
