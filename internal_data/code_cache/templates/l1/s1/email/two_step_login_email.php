...
<p>To complete the login to your account (or to complete two-step verification setup) at ' . (((('<a href="' . $__templater->fn('link', array('canonical:index', ), true)) . '">') . $__templater->escape($__vars['xf']['options']['boardTitle'])) . '</a>') . ', you must enter the following code:</p>' . '
