...
'depthN' => function($__templater, array $__arguments, array $__vars)
{
	...
	$__finalCompiled .= '
	<li>
		<a href="' . $__templater->fn('link', array('pages', $__vars['node'], ), true) . '" class="subNodeLink subNodeLink--page">' . $__templater->escape($__vars['node']['title']) . '</a>
...
'page' => function($__templater, array $__arguments, array $__vars)
{
	...
	$__finalCompiled .= '
				<h3 class="node-title">
					<a href="' . $__templater->fn('link', array('pages', $__vars['node'], ), true) . '" data-xf-init="' . (($__vars['descriptionDisplay'] == 'tooltip') ? 'element-tooltip' : '') . '" data-shortcut="node-description">' . $__templater->escape($__vars['node']['title']) . '</a>
				</h3>
				';
