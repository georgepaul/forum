...
<div class="block">
	...
	<div class="block-container">
		<h2 class="block-tabHeader tabs">
			<a href="' . $__templater->fn('link', array('reports', ), true) . '" class="tabs-tab is-active">' . 'Active reports' . '</a>
			<a href="' . $__templater->fn('link', array('reports/closed', ), true) . '" class="tabs-tab">' . 'Closed reports' . '</a>
		</h2>
