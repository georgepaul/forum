...
return array('macros' => array(), 'code' => function($__templater, array $__vars)
{
	...
	';
		...
		$__finalCompiled .= '
	';
		$__templater->pageParams['pageH1'] = $__templater->preEscaped('Search results for query' . $__vars['xf']['language']['label_separator'] . ' <a href="' . $__templater->fn('link', array('search', $__vars['search'], array('searchform' => '1', ), ), true) . '"><em>' . $__templater->escape($__vars['search']['search_query']) . '</em></a>');
		$__finalCompiled .= '
';
	} else {
		$__finalCompiled .= '
	...
	if ($__vars['modTypes']) {
		...
		if ($__vars['activeModType']) {
			$__finalCompiled .= '
									...
									<a href="' . $__templater->fn('link', array('search', $__vars['search'], array('page' => (($__vars['page'] > 1) ? $__vars['page'] : ''), ), ), true) . '" class="menu-linkRow">' . 'Disable' . '</a>
								';
		}
		$__finalCompiled .= '
							</div>
