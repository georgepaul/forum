	...
	';
		...
		<div class="block" data-widget-section="staffMembers"' . $__templater->fn('widget_data', array($__vars['widget'], ), true) . '>
			<div class="block-container">
				<h3 class="block-minorHeader"><a href="' . $__templater->fn('link', array('members', null, array('key' => 'staff_members', ), ), true) . '">' . 'Staff online' . '</a></h3>
				<ul class="block-body">
				' . $__compilerTemp1 . '
				</ul>
			</div>
...
<div class="block" data-widget-section="onlineNow"' . $__templater->fn('widget_data', array($__vars['widget'], ), true) . '>
	...
	$__finalCompiled .= '
		...
		<div class="block-footer">
			<span class="block-footer-counter">' . 'Total:&nbsp;' . $__templater->fn('number', array($__vars['online']['counts']['total'], ), true) . ' (members:&nbsp;' . $__templater->fn('number', array($__vars['online']['counts']['members'], ), true) . ', guests:&nbsp;' . $__templater->fn('number', array($__vars['online']['counts']['guests'], ), true) . ')' . '</span>
		</div>
	</div>
</div>';
