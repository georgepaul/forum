...
{
	$__finalCompiled = '';
	if ($__templater->fn('count', array($__vars['smiliesInfo']['smilies'], ), false) > 1) {
		$__finalCompiled .= '
	<div>
		...
		if ($__templater->isTraversable($__vars['smiliesInfo']['smilieCategories'])) {
			foreach ($__vars['smiliesInfo']['smilieCategories'] AS $__vars['categoryId'] => $__vars['category']) {
				...
				<a class="tabs-tab ' . (($__vars['i'] == 1) ? 'is-active' : '') . '"
					role="tab" tabindex="0" aria-controls="' . $__templater->fn('unique_id', array('smilies' . $__vars['i'], ), true) . '">' . $__templater->escape($__vars['category']['title']) . '</a>
			';
				}
			}
		}
		...
		if ($__templater->isTraversable($__vars['smiliesInfo']['smilieCategories'])) {
			foreach ($__vars['smiliesInfo']['smilieCategories'] AS $__vars['categoryId'] => $__vars['category']) {
				...
				<li class="' . (($__vars['i'] == 1) ? 'is-active' : '') . '" role="tabpanel" id="' . $__templater->fn('unique_id', array('smilies' . $__vars['i'], ), true) . '">
				';
