...
'title' => function($__templater, array $__arguments, array $__vars)
{
	...
	$__vars['meta'] = $__templater->preEscaped('
		...
		<meta property="twitter:title" content="' . $__templater->filter($__templater->fn('snippet', array($__vars['title'], 70, ), false), array(array('for_attr', array()),), true) . '" />
	');
	$__finalCompiled .= '
	' . $__templater->callMacro(null, 'output', array(
		'option' => 'meta_title',
...
'description' => function($__templater, array $__arguments, array $__vars)
{
	...
	';
	$__vars['meta'] = $__templater->preEscaped('
		<meta name="description" content="' . $__templater->filter($__templater->fn('snippet', array($__templater->filter($__vars['description'], array(array('strip_tags', array()),), false), 160, ), false), array(array('for_attr', array()),), true) . '" />
		<meta property="og:description" content="' . $__templater->filter($__templater->fn('snippet', array($__templater->filter($__vars['description'], array(array('strip_tags', array()),), false), 300, ), false), array(array('for_attr', array()),), true) . '" />
		<meta property="twitter:description" content="' . $__templater->filter($__templater->fn('snippet', array($__templater->filter($__vars['description'], array(array('strip_tags', array()),), false), 200, ), false), array(array('for_attr', array()),), true) . '" />
	');
	$__finalCompiled .= '
	' . $__templater->callMacro(null, 'output', array(
