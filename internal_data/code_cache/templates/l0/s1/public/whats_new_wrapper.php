...
return array('macros' => array('links' => function($__templater, array $__arguments, array $__vars)
{
	...
	if ($__vars['xf']['options']['enableNewsFeed']) {
		...
		if ($__vars['xf']['visitor']['user_id']) {
			$__finalCompiled .= '
			<a class="' . $__templater->escape($__vars['baseClass']) . ' ' . (($__vars['pageSelected'] == 'news_feed') ? $__templater->escape($__vars['selectedClass']) : '') . '" href="' . $__templater->fn('link', array('whats-new/news-feed', ), true) . '" rel="nofollow">' . 'Your news feed' . '</a>
		';
		}
		$__finalCompiled .= '

		<a class="' . $__templater->escape($__vars['baseClass']) . ' ' . (($__vars['pageSelected'] == 'latest_activity') ? $__templater->escape($__vars['selectedClass']) : '') . '" href="' . $__templater->fn('link', array('whats-new/latest-activity', ), true) . '" rel="nofollow">' . 'Latest activity' . '</a>
	';
	}
	$__finalCompiled .= '
	' . '
