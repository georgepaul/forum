...
return array('macros' => array(), 'code' => function($__templater, array $__vars)
{
	...
	if ($__vars['xf']['options']['enableMemberList']) {
		$__compilerTemp2 .= '
					<a class="blockLink ' . (($__vars['pageSelected'] == 'member_list') ? 'is-selected' : '') . '" href="' . $__templater->fn('link', array('members/list', ), true) . '">' . 'Registered members' . '</a>
				';
	}
	...
	<div class="block">
		<div class="block-container">
			...
			<div class="block-body">
				<a class="blockLink ' . (($__vars['pageSelected'] == 'overview') ? 'is-selected' : '') . '" href="' . $__templater->fn('link', array('members', ), true) . '">' . 'Overview' . '</a>
				' . $__compilerTemp1 . '
				' . $__compilerTemp2 . '
			</div>
		</div>
