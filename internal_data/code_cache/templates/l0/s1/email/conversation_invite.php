...
' . '<p>' . $__templater->escape($__vars['sender']['username']) . ' added you to an existing conversation at ' . (((('<a href="' . $__templater->fn('link', array('canonical:index', ), true)) . '">') . $__templater->escape($__vars['xf']['options']['boardTitle'])) . '</a>') . '.</p>' . '
