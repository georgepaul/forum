...
<p>Your email at ' . (((('<a href="' . $__templater->fn('link', array('canonical:index', ), true)) . '">') . $__templater->escape($__vars['xf']['options']['boardTitle'])) . '</a>') . ' was recently changed to ' . $__templater->escape($__vars['newEmail']) . '. If you made this change, you may ignore this message.</p>
