...
';
	...
	<div class="blockMessage blockMessage--important blockMessage--iconic">
		...
		<a href="' . $__templater->fn('link', array('account/two-step/manage', array('provider_id' => 'backup', ), ), true) . '">' . 'View your backup codes.' . '</a>
...
';
	...
	<div class="block">
		...
		if ($__vars['currentTrustRecord']) {
			$__finalCompiled .= '
					<div class="block-row block-row--separated">
						' . 'This device is currently trusted until ' . $__templater->fn('date', array($__vars['currentTrustRecord']['trusted_until'], ), true) . '. You will not need to complete two-step verification from this device until then. You may choose to stop trusting this device so that you will be prompted to complete two-step verification when you next log in.' . '
