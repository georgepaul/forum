...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Closed reports: ' . $__templater->fn('date', array($__vars['timeFrame']['0'], ), true) . ' - ' . $__templater->fn('date', array($__vars['timeFrame']['1'], ), true) . '');
	$__finalCompiled .= '
...
<div class="block">
	...
	<div class="block-container">
		<h2 class="block-tabHeader tabs">
			<a href="' . $__templater->fn('link', array('reports', ), true) . '" class="tabs-tab">' . 'Active reports' . '</a>
			<a href="' . $__templater->fn('link', array('reports/closed', ), true) . '" class="tabs-tab is-active">' . 'Closed reports' . '</a>
		</h2>
